...
import { ChevronLeft, FolderOpen, Plus, Settings } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="relative h-screen bg-white border-r border-border flex flex-col overflow-hidden flex-shrink-0 shadow-header"
    >
      ...
      <div className="p-3 border-t border-border space-y-0.5">
        {[
          ...
          { href: "/projects", icon: Settings, label: "Settings" },
        ].map(item => (
          <Link
